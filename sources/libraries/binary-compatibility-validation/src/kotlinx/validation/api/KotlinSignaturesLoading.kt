...
@ExternalApi
fun List<ClassBinarySignature>.filterOutNonPublic(
...
@ExternalApi
fun List<ClassBinarySignature>.retainExplicitlyIncludedIfDeclared(
...
fun replaceDots(dotSeparated: String): String =
